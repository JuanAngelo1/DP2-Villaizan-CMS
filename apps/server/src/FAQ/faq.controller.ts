...
export class FaqController {
    ...
    @Get("obtenerTodos")
    async getFAQS(@Req () request: Request, @Res() response: Response): Promise<any> {
        try{
    ...
    @Post("crear")
    async createFAQ(@Body() data: FAQDto, @Res() response: Response): Promise<any> {
        try {
    ...
    @Put('eliminar/:id')  
    async deleteFAQ(@Param('id',ParseIntPipe) id: number, @Res() response: Response): Promise<any> {
        try {
    ...
    async updateFAQ(
      ...
      @Body() data: FAQDto,@Res() response: Response
    ) {
      try {
